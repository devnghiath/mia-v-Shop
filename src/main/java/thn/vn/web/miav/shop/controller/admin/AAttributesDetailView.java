...
@Controller
@RequestMapping(value = "/admin/attributesDetail")
public class AAttributesDetailView extends AdminControllerBase {
    ...
    public String getAction(Model model, @PathVariable String action) {
        return contentPage("forms/attributesDetail",model);
    }
